...
def main() -> None:
    ...
    url = f"{BASE_URL}/api/v2/search-report/table/details"
    ...
    # Опциональные поля body: pastPeriod, subjectId, brandName, tagId, nmIds, includeSubstitutedSKUs, includeSearchTexts
    params = None
    payload = {
        "currentPeriod": {
            "start": "2026-01-01",
